    ...
    <MainSectionContent>
      <PictureBackground>
        <source
          ...
          srcSet={require('../../../../assets/images/woman-bus-3x.jpg')}
        />
        <source
          media="(min-width: 1024px)"
          srcSet={require('../../../../assets/images/woman-bus-2x.jpg')}
        />
        <source
        ...
        <source
          ...
          srcSet={require('../../../../assets/images/woman-bus-0.75x.jpg')}
        />
        <source
          media="(min-width: 0px)"
          srcSet={require('../../../../assets/images/woman-bus-0.5x.jpg')}
        />
        <ImageBackground
          importance="high"
          srcSet={require('../../../../assets/images/woman-bus-1x.jpg')}
      ...
      <PictureCard>
        <source
          media="(min-width: 1280px)"
          srcSet={require('../../../../assets/images/home_products-3x.png')}
        />
        <source
          media="(min-width: 1024px)"
          srcSet={require('../../../../assets/images/home_products-3x.png')}
        ...
        <source
          media="(min-width: 768px)"
          srcSet={require('../../../../assets/images/home_products-1x.png')}
        />
        <source
          media="(min-width: 480px)"
          srcSet={require('../../../../assets/images/home_products-0.75x.png')}
        />
        <source
          media="(min-width: 0px)"
          srcSet={require('../../../../assets/images/home_products-0.5x.png')}
        />
        <ImageCard
